...
function SchedulePayment() {
    ...
    const [recurrence, setRecurrence] = useState("No"); // Default to 'No'
    ...
    const handlePaymentTypeChange = (e) => {
        ...
        if (type === "one-off") {
            setRecurrence("No");
            setEndDate(""); // Clear end date for one-off payment
        } else {
            setRecurrence("weekly"); // Default to weekly for recurring
        }
    };
